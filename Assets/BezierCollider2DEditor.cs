...
public class BezierCollider2DEditor : Editor
{
    ...
    void OnSceneGUI()
    {
        if (bezierCollider != null)
        {
            ...
            var fmh_66_138_638543824482753628 = Quaternion.identity; bezierCollider.firstPoint = Handles.FreeMoveHandle(bezierCollider.transform.position + ((Vector3)bezierCollider.firstPoint), 0.04f * HandleUtility.GetHandleSize(bezierCollider.transform.position + ((Vector3)bezierCollider.firstPoint)), Vector3.zero, Handles.DotHandleCap) - bezierCollider.transform.position;
            var fmh_67_140_638543824482783227 = Quaternion.identity; bezierCollider.secondPoint = Handles.FreeMoveHandle(bezierCollider.transform.position + ((Vector3)bezierCollider.secondPoint), 0.04f * HandleUtility.GetHandleSize(bezierCollider.transform.position + ((Vector3)bezierCollider.secondPoint)), Vector3.zero, Handles.DotHandleCap) - bezierCollider.transform.position;
            var fmh_68_152_638543824482792023 = Quaternion.identity; bezierCollider.handlerFirstPoint = Handles.FreeMoveHandle(bezierCollider.transform.position + ((Vector3)bezierCollider.handlerFirstPoint), 0.04f * HandleUtility.GetHandleSize(bezierCollider.transform.position + ((Vector3)bezierCollider.handlerFirstPoint)), Vector3.zero, Handles.DotHandleCap) - bezierCollider.transform.position;
            var fmh_69_154_638543824482800854 = Quaternion.identity; bezierCollider.handlerSecondPoint = Handles.FreeMoveHandle(bezierCollider.transform.position + ((Vector3)bezierCollider.handlerSecondPoint), 0.04f * HandleUtility.GetHandleSize(bezierCollider.transform.position + ((Vector3)bezierCollider.handlerSecondPoint)), Vector3.zero, Handles.DotHandleCap) - bezierCollider.transform.position;
